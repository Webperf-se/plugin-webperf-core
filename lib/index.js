...
export default class WebPerfPlugin extends SitespeedioPlugin {
  ...
  async processMessage(message, queue) {
    ...
    switch (message.type) {
      ...
      case 'webperf-plugin-javascript.pageSummary': {
        this.appendIssuesToData(message.data.knowledgeData);
        break;
      }
      case 'webperf-plugin-html.pageSummary': {
        this.appendIssuesToData(message.data.knowledgeData);
        break;
      }
      case 'webperf-plugin-css.pageSummary': {
        this.appendIssuesToData(message.data.knowledgeData);
        break;
      }
      case 'webperf-plugin-accessibility-statement.pageSummary': {
        this.appendIssuesToData(message.data.knowledgeData);
        break;
      }
      case 'webperf-plugin-pagenotfound.pageSummary': {
        this.appendIssuesToData(message.data.knowledgeData);
        break;
      }
